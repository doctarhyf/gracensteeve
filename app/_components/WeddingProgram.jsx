...
const CoupleIcon = () => (
  <svg
    width="52"
    height="52"
    viewBox="90 20 180 150"
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
  >
    {/* Groom */}
    <circle cx="120" cy="38" r="10" stroke="#b8972a" strokeWidth="2" />
    <rect x="108" y="18" width="24" height="14" rx="2" fill="#b8972a" />
    <path
      d="M110 48 Q107 65 109 90 L131 90 Q133 65 130 48Z"
      stroke="#b8972a"
      strokeWidth="2"
      fill="none"
    />
    <path
      d="M115 48 L120 58 L125 48"
      stroke="#b8972a"
      strokeWidth="1.5"
      fill="none"
    />
    <line x1="110" y1="90" x2="108" y2="118" stroke="#b8972a" strokeWidth="2" />
    <line x1="130" y1="90" x2="132" y2="118" stroke="#b8972a" strokeWidth="2" />
    {/* Groom arm toward bride */}
    <path
      d="M130 62 Q142 70 148 78"
      stroke="#b8972a"
      strokeWidth="2"
      strokeLinecap="round"
      fill="none"
    />
    {/* Bride */}
    <circle cx="170" cy="38" r="10" stroke="#b8972a" strokeWidth="2" />
    <circle cx="170" cy="26" r="5" stroke="#b8972a" strokeWidth="1.5" />
    <path
      d="M158 48 Q156 65 160 78 L180 78 Q184 65 182 48Z"
      stroke="#b8972a"
      strokeWidth="2"
      fill="none"
    />
    <path
      d="M160 78 Q150 100 153 130 L187 130 Q190 100 180 78Z"
      stroke="#b8972a"
      strokeWidth="2"
      fill="none"
    />
    {/* Bride arm toward groom */}
    <path
      d="M158 62 Q148 70 144 78"
      stroke="#b8972a"
      strokeWidth="2"
      strokeLinecap="round"
      fill="none"
    />
    {/* Joined hands */}
    <ellipse cx="146" cy="80" rx="5" ry="3.5" fill="#b8972a" opacity="0.8" />
    {/* Heart */}
    <path
      d="M145 52 C145 46 137 42 134 47 C131 52 136 58 145 65 C154 58 159 52 156 47 C153 42 145 46 145 52Z"
      fill="#b8972a"
    />
  </svg>
);
...
const sections = [
...

  {
    ...
    note: true,
    detail:
      "Les mariés se tiendront à l’accueil pour vous recevoir chaleureusement et souhaiteraient recevoir les cadeaux enespèce.",
    hasDivider: false,
  },
];
